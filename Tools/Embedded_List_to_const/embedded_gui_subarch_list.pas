...
type
  Ti8086ControllerDataList = array of array of String;

const
  i8086ControllerDataList : Ti8086ControllerDataList = (
  ('controllertypestr,controllerunitstr,cputype,fputype,flashbase,flashsize,srambase,sramsize'
  );

type
  Taarch64ControllerDataList = array of array of String;

const
  aarch64ControllerDataList : Taarch64ControllerDataList = (
  ('controllertypestr,controllerunitstr,cputype,fputype,flashbase,flashsize,srambase,sramsize'
  );

type
  Tpowerpc64ControllerDataList = array of array of String;

const
  powerpc64ControllerDataList : Tpowerpc64ControllerDataList = (
  ('controllertypestr,controllerunitstr,cputype,fputype,flashbase,flashsize,srambase,sramsize'
  );
...
type
  Tx86_64ControllerDataList = array of array of String;

const
  x86_64ControllerDataList : Tx86_64ControllerDataList = (
  ('controllertypestr,controllerunitstr,cputype,fputype,flashbase,flashsize,srambase,sramsize'
  );

type
  Triscv64ControllerDataList = array of array of String;

const
  riscv64ControllerDataList : Triscv64ControllerDataList = (
  ('controllertypestr,controllerunitstr,cputype,fputype,flashbase,flashsize,srambase,sramsize'
  );

type
  TpowerpcControllerDataList = array of array of String;

const
  powerpcControllerDataList : TpowerpcControllerDataList = (
  ('controllertypestr,controllerunitstr,cputype,fputype,flashbase,flashsize,srambase,sramsize'
  );
...
type
  TjvmControllerDataList = array of array of String;

const
  jvmControllerDataList : TjvmControllerDataList = (
  ('controllertypestr,controllerunitstr,cputype,fputype,flashbase,flashsize,srambase,sramsize'
  );

type
  TsparcControllerDataList = array of array of String;

const
  sparcControllerDataList : TsparcControllerDataList = (
  ('controllertypestr,controllerunitstr,cputype,fputype,flashbase,flashsize,srambase,sramsize'
  );

type
  Tm68kControllerDataList = array of array of String;

const
  m68kControllerDataList : Tm68kControllerDataList = (
  ('controllertypestr,controllerunitstr,cputype,fputype,flashbase,flashsize,srambase,sramsize'
  );
...
type
  Ti386ControllerDataList = array of array of String;

const
  i386ControllerDataList : Ti386ControllerDataList = (
  ('controllertypestr,controllerunitstr,cputype,fputype,flashbase,flashsize,srambase,sramsize'
  );

type
  Tsparc64ControllerDataList = array of array of String;

const
  sparc64ControllerDataList : Tsparc64ControllerDataList = (
  ('controllertypestr,controllerunitstr,cputype,fputype,flashbase,flashsize,srambase,sramsize'
  );
const
  i8086_SubArch_List = 
