...
function FindPara(const Source: string; Sub: TStringArray; FirstSpace: boolean = True): string;
var
  p, i, Index: integer;
begin
  Result := '';
...
begin
  Result:= FindPara(Source, [Sub], FirstSpace);
end;
